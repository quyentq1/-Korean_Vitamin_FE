...
const RoleManagement = () => {
  ...
  const availablePermissions = [
    { id: 'view_tests', name: t('staff.roleManagement.perm.viewTests'), category: 'Tests' },
    { id: 'take_tests', name: t('staff.roleManagement.perm.takeTests'), category: 'Tests' },
    { id: 'create_questions', name: t('staff.roleManagement.perm.createQuestions'), category: 'Questions' },
    { id: 'edit_questions', name: t('staff.roleManagement.perm.editQuestions'), category: 'Questions' },
    { id: 'delete_questions', name: t('staff.roleManagement.perm.deleteQuestions'), category: 'Questions' },
    { id: 'create_quizzes', name: t('staff.roleManagement.perm.createQuizzes'), category: 'Quizzes' },
    { id: 'grade_assignments', name: t('staff.roleManagement.perm.gradeAssignments'), category: 'Grading' },
    { id: 'view_reports', name: t('staff.roleManagement.perm.viewReports'), category: 'Reports' },
    { id: 'manage_classes', name: t('staff.roleManagement.perm.manageClasses'), category: 'Classes' },
    { id: 'manage_students', name: t('staff.roleManagement.perm.manageStudents'), category: 'Students' },
    { id: 'assign_roles', name: t('staff.roleManagement.perm.assignRoles'), category: 'Users' },
    { id: 'import_students', name: t('staff.roleManagement.perm.importStudents'), category: 'Students' },
    { id: 'approve_questions', name: t('staff.roleManagement.perm.approveQuestions'), category: 'Questions' },
    { id: 'assign_teachers', name: t('staff.roleManagement.perm.assignTeachers'), category: 'Classes' },
    { id: 'approve_schedules', name: t('staff.roleManagement.perm.approveSchedules'), category: 'Classes' },
    { id: 'system_settings', name: t('staff.roleManagement.perm.systemSettings'), category: 'System' },
    { id: 'user_management', name: t('staff.roleManagement.perm.userManagement'), category: 'Users' },
    { id: 'view_logs', name: t('staff.roleManagement.perm.viewLogs'), category: 'System' },
    { id: 'manage_payments', name: t('staff.roleManagement.perm.managePayments'), category: 'Payments' },
    { id: 'full_access', name: t('staff.roleManagement.perm.fullAccess'), category: 'System' },
  ];
  ...
  const handleDeleteRole = async (role) => {
    const result = await Swal.fire({
      icon: 'question',
      title: t('staff.roleManagement.deleteConfirmTitle'),
      text: t('staff.roleManagement.deleteConfirmText', { roleName: role.name }),
