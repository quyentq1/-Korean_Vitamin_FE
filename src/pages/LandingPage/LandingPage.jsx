                        ...
                        <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:shadow-xl transition">
                            ...
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-start gap-2">
                                    ...
                                    <span className="text-gray-700">{t('landing.pricing.free.item1', '5 bài test miễn phí')}</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-green-500 mt-1">✓</span>
                        ...
                        <div className="bg-white border-2 border-primary-500 rounded-2xl p-8 hover:shadow-xl transition relative">
                            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                                <span className="bg-accent-orange text-white px-4 py-1 rounded-full text-sm font-semibold">
                                    {t('landing.pricing.popular', 'Phổ biến')}
                                </span>
                            </div>
                            <div className="text-center mb-6">
                                <div className="text-4xl mb-3">💎</div>
                                <h3 className="text-2xl font-bold text-gray-900 mb-2">
                                    {t('landing.pricing.pertest.name', 'Trả Theo Bài')}
                                </h3>
                                <div className="text-4xl font-bold text-primary-600 mb-2">100k - 200k</div>
                                <p className="text-gray-600 text-sm">
                                    {t('landing.pricing.pertest.desc', 'Mỗi bài test bổ sung')}
                                </p>
                            </div>
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-start gap-2">
                                    <span className="text-green-500 mt-1">✓</span>
                                    <span className="text-gray-700">{t('landing.pricing.pertest.item1', 'Tất cả quyền gói miễn phí')}</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-green-500 mt-1">✓</span>
                                    <span className="text-gray-700">{t('landing.pricing.pertest.item2', 'Làm bài test không giới hạn')}</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-green-500 mt-1">✓</span>
                                    <span className="text-gray-700">{t('landing.pricing.pertest.item3', 'Thi viết và nói')}</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-gray-400 mt-1">✗</span>
                                    <span className="text-gray-400">{t('landing.pricing.pertest.item4', 'Lớp học online')}</span>
                                </li>
                            </ul>
                            <button className="w-full py-3 bg-primary-600 text-white rounded-xl font-semibold hover:bg-primary-700 transition">
                                {t('landing.pricing.pertest.cta', 'Mua ngay')}
                            </button>
                        </div>
