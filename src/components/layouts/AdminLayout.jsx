...
/**
 * AdminLayout - Sidebar và Topbar cho Admin
 */
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50 flex">
      ...
      `}>
        {/* Sidebar Header */}
        <div className="h-16 flex items-center justify-between px-6 border-b border-gray-200 shrink-0 bg-gradient-to-r from-slate-700 to-slate-800">
        ...
        {/* Admin Info Card */}
        <div className="p-4 m-4 bg-gradient-to-br from-slate-50 to-gray-50 rounded-xl border border-slate-200">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-gradient-to-br from-slate-700 to-slate-800 rounded-full flex items-center justify-center text-white font-bold text-lg shrink-0">
          ...
          <div className="grid grid-cols-3 gap-2 mt-3 pt-3 border-t border-slate-200">
            <div className="text-center">
              ...
              <p className="text-sm font-bold text-slate-700">156</p>
            </div>
            <div className="text-center">
            ...
            <button
              ...
              className={`
                ...
                ${isActive(item.path)
                  ...
                  : 'text-gray-600 hover:bg-gradient-to-r hover:from-slate-50 hover:to-gray-50'
                }
              `}
            >
              {item.icon}
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50 shrink-0">
          ...
          >
            ...
            <span className="font-medium">{t('admin.settings', 'Cài đặt')}</span>
          </button>
          <button
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-8 shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-3 pl-3 border-l border-gray-200">
              ...
              <div className="w-10 h-10 bg-gradient-to-br from-slate-700 to-slate-800 rounded-full flex items-center justify-center text-white font-semibold shrink-0">
                {user?.fullName?.charAt(0) || user?.username?.charAt(0) || 'A'}
              </div>
              <button
                onClick={handleLogout}
